...
const userDataDir = mkdtempSync(join(tmpdir(), "guidepage-mobile-qa-"));
...
try {
  ...
  assert(landing.viewport.width === 390, "Mobile viewport width was not applied.");
  ...
  assert(!landing.overflowX, "Landing page has horizontal overflow on mobile.");
  ...
  assert(!detail.overflowX, "Detail page has horizontal overflow on mobile.");
