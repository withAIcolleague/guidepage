...
- [x] iframe 중심 미리보기를 ResourcePreview 카드/체크리스트 중심 구조로 전환
- [x] ResourcePreview 구조를 `qa:desktop`과 `validate:layout`에서 검출

## Current Next Actions

1. [Workflow Expansion Round 3 Plan](./workflow-expansion-round3-plan.md)의 첫 후보부터 실제 데이터에 반영한다.
2. 새 체인부터 중요한 도구에 수동 checklist 필드를 붙일지 검토한다.
