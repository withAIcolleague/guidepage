            ...
            <div className="relative mx-auto max-w-6xl">
                ...
                <div className="mb-12 text-center">
                    ...
                    <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
                        서비스 간 연관성을 따라 탐색하세요.
                        <br />
                        단계를 클릭하면 <strong>인앱 브라우저</strong>로 미리볼 수 있습니다.
                    </p>
                </div>
                ...
                <div className="overflow-x-auto pb-4">
                    <div className="relative mx-auto flex min-w-max items-center justify-center gap-0">
                            ...
                            <div key={node.title} className="flex items-center">
                                ...
                                >
                                    ...
                                    >
                                        {/* 스텝 번호 */}
                                        <div
                                            className={`absolute -top-2.5 left-1/2 flex h-5 w-5 -translate-x-1/2 items-center justify-center rounded-full bg-gradient-to-r text-[10px] font-bold text-white ${selected.gradient}`}
                                        >
                                            {index + 1}
                                        </div>
